...
> 🔒 **2026-06-14: репозитории приватны, доставка через token-gated сервер.** Команды установки — из @AITeamVIPBot. Прямые `raw`/`releases` ссылки ниже больше не работают публично (оставлены как историческая справка).
